        ...
        <div className="Panel" style={{height: "100vh"}}>
            <Row className="no-gutters" style={{backgroundImage: 'url('+icons+')', backgroundAttachment: "fixed", height: "100%"}}>
                ...
                <Col sm={8}>
                    ...
                    <h2 style={{color: "white", fontSize: "45px", paddingLeft: "9px"}}>I guess you're hear to learn about Kennys <ReactRotatingText items={['education', 'past projects', 'contact info']} /></h2> 
                </Col>
                <Col sm={2} />
            </Row>
        </div>
