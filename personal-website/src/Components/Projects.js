...
function Projects() {
    return (
        <div className="Panel" style={{height: "100vh"}}>
            ...
            <Row className="no-gutters" style={{ display: "flex", alignItems: "center", justifyContent: "center", backgroundImage: 'url('+icons+')', backgroundAttachment: "fixed", backgroundSize: "cover", height: "70%" }}>
                <div className="card">
            ...
            <Row className="no-gutters" style={{ backgroundImage: 'url('+icons+')', backgroundAttachment: "fixed", backgroundSize: "cover", height: "15%" }}>
                <Button id="github_button" variant="light" href="https://github.com/kennethprose" target="_blank">Check out the rest of my GitHub!</Button>
            </Row>
